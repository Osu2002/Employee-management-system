  ...
  <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item" v-bind:class="{ active: addActiveClass(['media.index']) }"
       ...
       <!-- Employee -->
       <li class="menu-item" v-bind:class="{ active: addActiveClass(['employee']) }"
      ...
      <li class="menu-item" v-bind:class="{
        ...
        <ul class="menu-sub">
          <li class="menu-item" v-bind:class="{
            active: addActiveClass(['settings.users','settings.users.create','settings.users.edit']),
          ...
          <li class="menu-item" v-bind:class="{
            active: addActiveClass(['settings.roles','settings.roles.create','settings.roles.edit', 'settings.roles.permissions']),
