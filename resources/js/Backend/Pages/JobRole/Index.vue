<template>
    <AppLayout>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h5>Job Roles Management</h5>
                        <p>Manage Job Roles Management.</p>
                        <div class="d-flex">
                            <Link class="btn btn-main btn-sm" :href="route('job-roles.create')" v-if="
                                $root.hasPermission('job-roles.create')
                            ">
                    ...
                    <div class="card-body">
                        <data-table ref="datatable" :id="'mytable'" :url="route('job-roles.getdata')"
                            :columns="columns">
                            <template #header>
                                <tr>
                                    <th width="10%">
            ...
            <div class="modal modal-top fade" id="deleteConfirm" tabindex="-1" aria-hidden="true"
...
export default {
    ...
    data() {
        return {
            columns: [
                ...
                {
                    data: "leave_types", // Leave types column
                    name: "leave_types",
                    orderable: false,
                    searchable: false,
                },
                ...
                {
                    data: "action", // Action buttons column
                    name: "action",
                    orderable: false,
                    searchable: false,
                },
            ],
            order: [[1, "desc"]], // Order by destination column
    ...
    mounted() {
        ...
        $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
            ...
            this.$inertia.visit(route("job-roles.edit", id));
        });
    ...
    methods: {
        ...
        updateStatus(id, status) {
            ...
            this.form.put(route("job-roles.change.status"), {
                preserveScroll: true,
                onSuccess: () => {
                    this.form.reset();
                    this.reloadTable();
