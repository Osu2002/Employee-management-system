        ...
        <div class="col-md-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h5>Employee</h5>
              <p>Manage Employee Users.</p>
              <div class="d-flex">
                <Link
                  class="btn btn-main btn-sm"
                  :href="route('employee.create')"
                  v-if="$root.hasPermission('employee.create')"
                >
  ...
  export default {
    ...
    mounted() {
      ...
      $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
        ...
        this.$inertia.visit(route("employee.edit", id)); //need to set edit route
      });
