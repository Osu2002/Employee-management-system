            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="col-12 mb-4">
                            <div class="row">
                                <div class="col-1">
                                    ...
                                    >
                                        <i
                                            class="back-icon fas fa-arrow-left p-2"
                                        ></i>
                                    </Link>
                                </div>
                        ...
                        <!-- <p>{{ employee ? employee.id : 'Loading...' }}</p> -->
                        <div class="d-flex">
                            <Link
                                class="btn btn-main btn-sm"
                                :href="
                                    route('employee.leaves.create', employee.id)
                                "
                    ...
                    <div class="card-body">
                        <data-table
                            ref="datatable"
                            :id="'mytable'"
                            :url="route('employee.leaves.getdata', employee.id)"
                            :columns="columns"
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <form
                            ...
                            @submit.prevent="deleteSelectedItems"
                        >
...
export default {
    ...
    mounted() {
        $("#mytable tbody").on("click", "tr .action_delete", (evt) => {
            ...
            const empid = $(evt.target).data("emp-id");
        ...
        $("#mytable tbody").on("click", "tr .action_edit", (evt) => {
            ...
            const empid = $(evt.target).data("emp-id");
            this.$inertia.visit(route("employee.leaves.edit", { empid, id })); //need to set edit route
        });
    ...
    methods: {
        ...
        updateStatus(id, status) {
            ...
            this.form.put(route("employee.change.status"), {
                preserveScroll: true,
                onSuccess: () => {
                    this.form.reset();
                    this.reloadTable();
        ...
        deleteSelectedItems() {
            this.form
                ...
                .post(route("employee.leaves.destroy"), {
                    onSuccess: () => {
                        this.resetForm();
                        this.reloadTable();
                        this.$root.showMessage(
